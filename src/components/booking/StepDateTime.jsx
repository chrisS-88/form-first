...
export default function StepDateTime({ data, setData, next, back }) {
  ...
  return (
    <StepContainer title="Choose Date & Time" subtitle="Please make a selection">
      <div className="space-y-16">
        <div>
          <h3 className="text-xl sm:text-xl font-semibold mb-6">Select a Date</h3>
          <DateGrid
            dates={dates}
            value={data.date}
            onChange={(date) =>
        ...
        <div>
          <h3 className="text-xl sm:text-xl font-semibold mb-6">Select a Time</h3>
